...
stdio↔HTTP proxy that connects MCP clients (Claude Desktop, Claude Code, Cursor, etc.) to a **remote** WordPress site running the [MCP Tools for Elementor (EMCP)](https://github.com/Digitizers/elementor-mcp) plugin.
